		...
		<div class="caja3">
			...
			<form action="sucursales/regis_sucur.php" method="post">
				...
				<div class="mb-3 mt-3 form">
					...
					<input class="form-control form2" type="text" required name="telefono" placeholder="Telefono">
				</div>
				<div class="mb-3 mt-3 form">
				...
				<div class="mb-3 mt-3 form">
					...
					<input class="form-control form2" type="text" required name="correo" placeholder="E-mail">
				</div>
				<div class="mb-3 form">
					<label class="form-label">Dias de labor</label>
					<input class="form-control form2" type="text" required name="dias" placeholder="Dias">
				</div>
				<div class="mb-3 form">
					<label class="form-label">Horario</label>
					<input class="form-control form2" type="text" required name="horario" placeholder="Horario">
				</div>
